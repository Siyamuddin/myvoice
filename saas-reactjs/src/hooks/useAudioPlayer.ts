...
/**
 * Plays 24kHz PCM Int16 chunks from Gemini via gap-free AudioContext scheduling.
 *
 * Call `ensureContext()` from a user gesture (e.g. mic button click) before playback
 * so the browser autoplay policy allows AudioContext to run.
 */
