...
/**
 * Returns true when the browser exposes getUserMedia for microphone capture.
 */
...
/**
 * Linear resampler with leftover-sample carry for correctness across chunks.
 */
...
/**
 * Captures microphone audio, downsamples to 16kHz mono PCM, and emits 20ms Int16 chunks.
 */
